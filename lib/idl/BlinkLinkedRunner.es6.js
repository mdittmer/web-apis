...
// class StateMemo extends Memo {
//   init(opts) {
//     if (!opts.delegate) throw new Error('StateMemo requires "delegate"');
//     this.delegate = opts.delegate;
//     super.init(opts);
//   }

//   get delegates() { return this.delegate.delegates; }
//   set delegates(delegates) { return this.delegate.delegates = delegates; }

//   f(o) {
//     // Simplifies projecting foo into {foo} for state creation.
//     o = this.liftInput(o);

//     const input = this.inKey ? o[this.inKey] : o;
//     return Promise.resolve(this.delegate.f(input)).then(value => {
//       if (this.outKey) {
//         (this.inKey ? o : {})[this.outKey] = value;
//         return o;
//       }
//       return value;
//     });
...
//   liftInput(o) { return o; }
// }

// class StateArrayMemo extends ArrayMemo {
//   liftInput(o) { return o; }

//   f(o) {
//     // Simplifies projecting [...] into {key: [...]} for state creation.
//     o = this.liftInput(o);

//     const input = this.inKey ? o[this.inKey] : o;
//     return Promise.resolve(super.f(input)).then(value => {
//       if (this.outKey) {
//         (this.inKey ? o : {})[this.outKey] = value;
//         return o;
//       }
