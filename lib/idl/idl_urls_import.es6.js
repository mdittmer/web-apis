...
const parseCacheDir = `${__dirname}/.parsecache`;
...
// TODO: Write SplitCache with "first" and "second". Fallback on "second" when
// not found in "first". Also, put to "first" when it failed and "second"
// delivered.

const urlCache = new FileCache({dir: './.urlcache'});
const idlCache = new JSONCache({
...
class ContentShellScraper extends Scraper {
}
