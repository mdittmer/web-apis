...
foam.CLASS({
  ...
  methods: [
    ...
    function getKey() {
      return `${this.name}_${this.version}_${this.os}_${this.os_version}`
    },
      ...
      Object.keys(this.browsers[0].interfaces).forEach(key => {
        ...
        apis.forEach(api => {
          ...
          !this.browsers[1].interfaces[key].indexOf(api) === -1) {
            if (key === 'XSLTProcessor'){
              console.log(this.browsers[1].interfaces[key]);
              console.log('1XSLTProcessor.'+api)
            }
      ...
      Object.keys(this.browsers[1].interfaces).forEach(key => {
        ...
        apis.forEach(api => {
          ...
          !this.browsers[0].interfaces[key].indexOf(api) === -1) {
            if (key === 'XSLTProcessor'){
              console.log('2XSLTProcessor.'+api)
            }
